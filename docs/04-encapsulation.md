...
We can further bundle the composite data type _and its associated functions_ together in another abstraction, called a _class_.  
...
[^2]: As a convention, we use Pascal case for class name and camel case for variable and method names in Java.
